    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50">
      ...
      >
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div
            className="absolute top-3/4 right-1/4 w-96 h-96 bg-purple-400/20 rounded-full blur-3xl animate-pulse"
            style={{ animationDelay: "1s" }}
          ></div>
          <div
            className="absolute bottom-1/4 left-1/3 w-48 h-48 bg-pink-400/20 rounded-full blur-3xl animate-pulse"
            style={{ animationDelay: "2s" }}
          ></div>
          <div
            className="absolute top-1/2 right-1/3 w-32 h-32 bg-indigo-400/30 rounded-full blur-2xl animate-bounce"
            style={{ animationDelay: "0.5s" }}
          ></div>
          <div
            className="absolute bottom-1/3 right-1/2 w-24 h-24 bg-violet-400/25 rounded-full blur-xl animate-bounce"
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-lg text-gray-600 leading-relaxed max-w-xl">
                  I drive product innovation through AI integration and
                  data-driven growth strategies. Passionate about building
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div className="space-y-6">
              <p className="text-lg text-gray-600 leading-relaxed">
                I'm a results-driven Product Manager with a passion for creating
                products that users love. With expertise in B2B SaaS, I bridge
                the gap between business objectives, user needs, and technical
                feasibility.
              </p>
              <p className="text-lg text-gray-600 leading-relaxed">
                My approach combines deep user research with cutting-edge AI
                technologies to build products that solve real problems and
            ...
            <div className="space-y-12">
              ...
              <div className="relative pl-20">
                ...
                <Card className="p-6 hover:shadow-lg transition-shadow duration-300">
                  ...
                  <ul className="space-y-2 text-gray-600">
                    <li>
                      • Launched a native mobile app featuring automated menu
                      generation by orchestrating recipe-selection models,
                      dietary-constraint guardrails, and user feedback loops in
                      SwiftUI & Firebase
                    </li>
                    <li>
                      • Conducted 25+ developer-style interviews to validate
                      function-calling prompts, error-handling flows, and
                      deployment surfaces ahead of private beta launch
                    </li>
                    <li>
                      • Built a Python scraper and GPT-based tagging pipeline to
                      ingest 200+ recipes into Airtable - defining data schemas
                      and monitoring pipelines to ensure reliability
                    </li>
                  </ul>
                </Card>
              </div>
              ...
              <div className="relative pl-20">
                ...
                <Card className="p-6 bg-gray-50 border-gray-200">
                  ...
                  <ul className="space-y-2 text-gray-600">
                    <li>
                      • Planned and executed a cross-continental move from
                      Europe to the Bay Area
                    </li>
                    <li>
                      • Onboarded into U.S. market research for product
                      opportunities
                    </li>
                    <li>
                      • Set up local networks, handled logistics, and prepared
                      for Eat Sip Repeat launch
                    </li>
                  </ul>
                </Card>
              </div>
              ...
              <div className="relative pl-20">
                ...
                <Card className="p-6 hover:shadow-lg transition-shadow duration-300">
                  ...
                  <ul className="space-y-2 text-gray-600">
                    <li>
                      • Owned roadmaps for key scheduling & time-tracking
                      modules, aligning Sales, Marketing & CS around a unified
                      vision
                    </li>
                    <li>
                      • Prioritized features via funnel drop-off analysis and
                      customer interviews - boosting feature adoption by 25%
                    </li>
                    <li>
                      • Partnered with Engineering to instrument event tracking
                      and build Mixpanel dashboards, accelerating data-driven
                      iterations
                    </li>
                    <li>
                      • Led performance optimization initiative that cut load
                      times on data-heavy views by 40% and reduced churn-related
              ...
              <div className="relative pl-20">
                ...
                <Card className="p-6 hover:shadow-lg transition-shadow duration-300">
                  ...
                  <ul className="space-y-2 text-gray-600">
                    <li>
                      • Defined and executed marketplace roadmap focused on
                      trust & fraud prevention - launching security features
                      that cut fraud claims by 15%
                    </li>
                    <li>
                      • Collaborated with UX and engineering teams to refine the
                      transaction flow, driving a 12% uplift in daily active
                      users (DAU)
                    </li>
                    <li>
                      • Set and tracked OKRs tied to business KPIs,
                      demonstrating clear ROI from product initiatives
                    </li>
                    <li>
                      • Conducted competitive analyses to uncover new market
                      opportunities and inform prioritization
                    </li>
                  </ul>
                </Card>
              </div>
              ...
              <div className="relative pl-20">
                ...
                <Card className="p-6 hover:shadow-lg transition-shadow duration-300">
                  ...
                  <ul className="space-y-2 text-gray-600">
                    <li>
                      • Managed end-to-end delivery of enterprise-grade NLP
                      chatbot projects for Fortune 500 clients
                    </li>
                    <li>
                      • Tuned NLU models and built annotation pipelines -
                      halving model update cycles and improving
                      intent-recognition accuracy to &gt;95%
                    </li>
                    <li>
                      • Coordinated cross-functional teams through design,
                      development & deployment phases, ensuring on-time,
                      on-budget delivery
                    </li>
                  </ul>
                </Card>
              ...
              <div className="relative pl-20">
                ...
                <Card className="p-6 hover:shadow-lg transition-shadow duration-300">
                  ...
                  <ul className="space-y-2 text-gray-600">
                    <li>
                      • Led Agile workflows across Engineering, Marketing &
                      Product to deliver a privacy-focused mobile application in
                      a fast-paced startup environment
                    </li>
                    <li>
                      • Designed and enforced sprint processes that increased
                      team throughput by 30%
                    </li>
                    <li>
                      • Proposed and scoped internal product improvements -
                      reducing QA cycle times by 20%
                    </li>
                  </ul>
                </Card>
              </div>
              ...
              <div className="relative pl-20">
                ...
                <Card className="p-6 hover:shadow-lg transition-shadow duration-300">
                  ...
                  <ul className="space-y-2 text-gray-600">
                    <li>
                      • Led efforts to attract new participants to the
                      Electronic Trading System for government assets,
                      successfully delivering three large-scale projects
                    </li>
                    <li>
                      • Managed deliverables, supported solution design &
                      architecture, and established a trusted-advisor status
                      with key stakeholders
                    </li>
                    <li>
                      • Facilitated the first-ever electronic auction of
                      government assets - a landmark in public asset management
                    </li>
                  </ul>
                </Card>
              </div>
              ...
              <div className="relative pl-20">
                ...
                <Card className="p-6 hover:shadow-lg transition-shadow duration-300">
                  ...
                  <ul className="space-y-2 text-gray-600">
                    <li>
                      • Team-lead for Casino Mobile's CDMs, directly managing a
                      team of 6 and ensuring high-quality, timely deliveries to
                      all casino clients
                    </li>
                    <li>
                      • Managed multiple parallel projects and served as the
                      sole communication hub for product inquiries and
                      escalations
                    </li>
                    <li>
                      • Built strategic client partnerships, driving
                      satisfaction and long-term engagement
                    </li>
                    <li>
                      • Overseen integration troubleshooting, risk mitigation,
                      and external dependencies to keep releases on schedule
                    </li>
                  </ul>
                </Card>
              </div>
              ...
              <div className="relative pl-20">
                ...
                <Card className="p-6 hover:shadow-lg transition-shadow duration-300">
                  ...
                  <ul className="space-y-2 text-gray-600">
                    <li>
                      • Managed a strategic account, doubling team size within
                      one year through strong client and team relationships
                    </li>
                    <li>
                      • Acted as mediator between stakeholders and delivery
                      teams, tracking milestones and reporting status
                    </li>
                    <li>
                      • Handled resource planning, project admin, and financial
                      tracking to ensure on-budget delivery
                    </li>
                    <li>
                      • Identified and resolved escalations, enhancing client
                      satisfaction and deepening relationships
                    </li>
                  </ul>
                </Card>
              </div>
            ...
            <Card className="p-8 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 text-center">
                ...
                <div>
                  ...
                  <p className="text-sm opacity-90">
                    Chatbots, NLP, and human-AI interaction
                  </p>
                </div>
                <div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 mt-4 max-w-2xl mx-auto">
              Sharing thoughts on product management, AI integration, and
