export const projectsData = {
  "eat-sip-repeat": {
    ...
    subtitle:
      "AI-powered iOS app that transforms recipe overwhelm into effortless, seasonally tailored dinner plans.",
    background:
      "Eat Sip Repeat is an AI-powered iOS app that transforms recipe overwhelm into effortless, seasonally tailored dinner plans. By curating menus based on what's fresh, generating smart shopping lists, and saving recipes from social feeds, the app bridges inspiration and execution for home cooks.",
    problem: [
    ...
    solution: [
      {
        ...
        description:
          "Interviewed 20+ home cooks to map pain points and validate demand for AI–driven, seasonally aware menu planning.",
        activities: [
      ...
      },
      {
        ...
        description:
          'Rapid, LLM-assisted "vibe-coding" in Figma + SwiftUI to iterate on wireframes and component designs in real time.',
        activities: [
      ...
      },
      {
        ...
        description:
          "A generation engine that recommends menus in under 2 s, factoring in seasonal produce, dietary constraints, and user preferences.",
        activities: [
      ...
      },
      {
        ...
        description:
          "Migrated data and auth from Airtable to Firebase to support surging beta tests and secure user data.",
        activities: [
    ...
    caseStudyLink: "https://esr-casestudy.lovable.app/",
  ...
  parim: {
    ...
    title: "PARiM",
    subtitle:
      "Workforce-management platform serving shift-based businesses – from hospitality to healthcare.",
    background:
      "PARiM is a workforce-management platform serving shift-based businesses – from hospitality to healthcare – that helps teams schedule, track, and manage staff with precision.",
    problem: [
    ...
    solution: [
      {
        ...
        description:
          "A standalone iOS & Android app that surfaces live shift rosters, swap requests, and push notifications.",
        activities: [
          "Defined MVP flows",
          "Rapid prototyping",
      ...
      },
      {
        ...
        description:
          "A behind-the-scenes rules engine enforcing labor-law hour limits and verifying required certifications at schedule-time.",
        activities: [
      ...
      },
      {
        ...
        description:
          "Optimised Scheduling flow and an Event Module to plan and staff one-off events with the same ease as recurring shifts.",
        activities: [
      ...
      },
      {
        ...
        description:
          "A set of front-end and back-end optimizations (smart data caching, query streamlining, and prioritized rendering) to accelerate large-table loads.",
        activities: [
  ...
  paxful: {
    ...
    subtitle:
      "Leading peer-to-peer cryptocurrency marketplace fraud prevention system.",
    background:
      "Paxful is a leading peer-to-peer cryptocurrency marketplace where buyers and sellers trade directly, leveraging escrow and reputation systems to foster trust. As Product Manager for the Marketplace, I partnered closely with Data Analysis and Fraud Prevention teams to harden our trading ecosystem against malicious activity.",
    problem: [
    ...
    solution: [
      {
        ...
        description:
          "A configurable engine that applies data-driven rules – velocity checks, reputation thresholds, and location anomalies – to flag high-risk trades in real time.",
        activities: [
      ...
      },
      {
        ...
        description:
          "A streamlined, partially automated process that routes flagged disputes through tiered review and triggers immediate provisional refunds when warranted.",
        activities: [
      ...
      },
      {
        ...
        description:
          "A live dashboard for support and fraud teams displaying key metrics – fraud flags per hour, dispute backlogs, and rule performance – enabling rapid tuning.",
        activities: [
